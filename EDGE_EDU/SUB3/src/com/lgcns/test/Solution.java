...
public class Solution {
	...
	private void loadServerCommandInfo() throws Exception {
		...
		for (ServerCommandInfo serverCommandInfo : commandInfoData.getServerCommandInfoList()) {
			System.out.println("serverCommandInfo.getCommand() " + serverCommandInfo.getCommand());
			System.out.println("serverCommandInfo.getCommand() " + serverCommandInfo.getForwardCommand());
